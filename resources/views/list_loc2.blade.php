...
<div class="uper">
    ...
    <div class=row>
      <div class="col w-100">
           <div class=" bg-primary d-flex align-items-center">
                <h3 class="card-title flex-grow-1" style="color:#fff"><i class="fas fa-users fa-1x" style="color:#fff"></i>Liste des locations</h3>
        ...
        <div class="form-group pr-3 mr-4 p-4">
                <a href="{{route('index_loc')}}">
                <button type="button" class="btn btn-info">liste précédente</button></a>
             </div>
  ...
  <table class="table table-striped mh-100">
    ...
    <thead>
        <tr>
          <th>Nom de cuisine</th>
          <th>Superficie</th>
          <th>Type meuble</th>
          <th>Nombre de balcon</th>
          <th >Nombre de guérite</th>
          <th>Image</th>
    ...
    <tbody>
        ...
        <tr>
            <td >{{$location->nrb_cuisine}}</td>
            <td>{{$location->super}}</td>
            <td>{{$location->estmeuble}}</td>
            <td>{{$location->nrb_bal}}</td>
            <td>{{$location->nrb_guer}}</td>
            <td>{{$location->img}}</td>
            <td>Autre</td> 
