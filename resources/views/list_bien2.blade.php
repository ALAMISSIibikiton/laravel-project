...
<div>
  ...
  <div class="d-flex justify-content-end">
        <div class="form-group mr-3">
          <label for="filtre_type">Rechercher un état</label>  
          <form action="/etat" method="get">
                  <div class="input-group">
                     <input type="text" name="etat" style="width:200px;" class="form-control" placeholder="Entrer un état" >
                     <span class="input-group-prepend">
...
<table class="table table-striped mh-100">
  ...
  <thead>
      <tr>
        <th style="font-weight:bold">coordonées</th>
        <th style="font-weight:bold">distance</th>
        <th style="font-weight:bold">Proximité</th>
